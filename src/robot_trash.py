...
class Robot(object):
    ...
    def add_objects(self):
        ...
        for object_idx in range(len(self.obj_mesh_ind)):
            ...
            # =================================Add Object=========================================
            ret_resp,ret_ints,ret_floats,ret_strings,ret_buffer = vrep.simxCallScriptFunction(self.sim_client, # vrep client id
                                                                                              'remoteApiCommandServer', # script description
                                                                                              vrep.sim_scripttype_childscript, # scriptHandleOrType
                                                                                              'importShape', # functionName
                                                                                              [0,0,255,0], # inInts
                                                                                              object_position + object_orientation + object_color, # inFloats
                                                                                              [curr_mesh_file, curr_shape_name], # inStrings
                                                                                               bytearray(), # inBuffer
                                                                                               vrep.simx_opmode_blocking) # vrep operation mode
            # =====================================================================================
    ...
    def get_camera_data(self):
        ...
        if self.is_sim:
            ...
            print('resolution length: ', len(resolution))
